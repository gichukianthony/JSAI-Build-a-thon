const globalConfig = {
  ...
  CHAT_BUTTON_LABEL_TEXT: 'Ask NutriPal',
  CHAT_CANCEL_BUTTON_LABEL_TEXT: 'Cancel',
  CHAT_VOICE_BUTTON_LABEL_TEXT: 'Voice input',
  CHAT_VOICE_REC_BUTTON_LABEL_TEXT: 'Listening...',
  CHAT_INPUT_PLACEHOLDER: 'e.g., "What are the health benefits of spinach?"',
  USER_IS_BOT: 'NutriPal',
  ...
  BRANDING_URL: '#',
  BRANDING_LOGO_ALT: 'NutriPal Logo',
  BRANDING_HEADLINE: 'Welcome to NutriPal! Your guide to healthier eating.',
...
const teaserListTexts = {
  TEASER_CTA_LABEL: 'Get Started',
  HEADING_CHAT: 'Chat with NutriPal',
  HEADING_ASK: 'Ask a nutrition question',
  DEFAULT_PROMPTS: [
    { description: 'Is avocado a fruit or a vegetable?' },
    { description: "What's a good source of vegan protein?" },
    { description: 'How do I make a healthy smoothie?' },
    { description: 'Which foods are high in Vitamin C?' },
    { description: 'What are the benefits of a Mediterranean diet?' },
  ],
};
